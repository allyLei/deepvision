...
'''
Defines the generator including resnet generator and unet generator.
...
import functools
from .utils import get_norm_layer, init_weights

class ResnetGenerator(nn.Module):

    def __init__(self, input_nc, output_nc, ngf=64,
                 norm='batch', use_dropout=False,
                 n_blocks=6, padding_type='reflect', init_type='normal'):
