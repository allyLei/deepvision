...
//                }
    ...
    public static String getHash(Bitmap img){
        Bitmap greyImg = convertGreyImg(img);
        int greyAvg = getAvg(greyImg);
        String bString = getBinary(greyImg, greyAvg);
        String hash = binaryString2hexString(bString);
        return hash;
    }

    public static int calcSimilarity(String s1, String s2) {
